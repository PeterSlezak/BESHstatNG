...
Public Class LinearModel_Tests
    ...
    Public Sub TermAnova_TypeIII_and_VIF_match_reference_WLS()
        ...
        Dim vif1 As Double = Double.NaN
        Dim vif2 As Double = Double.NaN
        For j As Integer = 0 To UBound(v, 2)
            If v(r1, j) IsNot Nothing AndAlso Not TypeOf v(r1, j) Is String Then vif1 = GetAsDouble(v(r1, j))
            If v(r2, j) IsNot Nothing AndAlso Not TypeOf v(r2, j) Is String Then vif2 = GetAsDouble(v(r2, j))
        Next
