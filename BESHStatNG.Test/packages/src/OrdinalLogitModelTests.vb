...
Public Class OrdinalLogitModel_Tests
    ...
    Private Shared Sub AssertMatrixAlmostEqual(expected(,) As Double, actual(,) As Double, tol As Double, Optional msg As String = "")
        ...
        Assert.AreEqual(UBound(expected, 1), UBound(actual, 1), "Row count differs. " & msg)
        Assert.AreEqual(UBound(expected, 2), UBound(actual, 2), "Col count differs. " & msg)
    ...
    Private Const expLL0 As Double = -521.5635222599769
    Private Const expAIC As Double = 972.1533193883627
    Private Const expBIC As Double = 988.8484638039704

    Private Const expCoxSnellR2 As Double = 0.15170649952729132
    Private Const expNagelkerkeR2 As Double = 0.17119054372123813
    Private Const expMcFaddenR2 As Double = 0.07570863544040773

    Private Const expModelChi2 As Double = 78.97372513159121
    Private Const expModelDF As Integer = 2

    Private Const expGOF As Double = 0.05568987448691587
    Private Const expGOFDF As Integer = 8

    Private Const expOverallAcc As Double = 0.4979166666666667
    ...
    Private Shared ReadOnly expProbs(,) As Double = {
        {0.597779542630, 0.259083295827, 0.143137161543},
        {0.597779542630, 0.259083295827, 0.143137161543},
        {0.597779542630, 0.259083295827, 0.143137161543},
        ...
        {0.233802575583, 0.317587816661, 0.448609607756},
        {0.233802575583, 0.317587816661, 0.448609607756},
        {0.312459755001, 0.334250119829, 0.353290125170},
        {0.312459755001, 0.334250119829, 0.353290125170},
        {0.312459755001, 0.334250119829, 0.353290125170}
    }
    ...
    Public Sub Fit_weighted_with_offset_matches_reference_basic()
        ...
        m.Calculate(regression.ReferenceCategory.Last)
    ...
    Public Sub Frequency_weights_match_expanded_unweighted_fit()
        ...
        mW.Calculate(regression.ReferenceCategory.Last)
        ...
        mU.Calculate(regression.ReferenceCategory.Last)
    ...
    Public Sub ReferenceCategory_First_with_reversed_labels_matches_Last()
        ...
        mLast.Calculate(regression.ReferenceCategory.Last)
        ...
        mFirst.Calculate(regression.ReferenceCategory.First)
    ...
    Public Sub Calculate_throws_if_Data_not_called()
        Dim m As New regression.OrdinalLogitModel()
        Assert.ThrowsException(Of InvalidOperationException)(Sub() m.Calculate())
    End Sub
    ...
    Public Sub wrapResiduals_throws_if_residuals_not_computed()
        ...
        m.Data(data, names, offset:=offs, weights:=w)
        m.Calculate(reference:=regression.ReferenceCategory.Last)
    ...
    Public Sub Zero_and_negative_weights_are_ignored_like_row_removal_in_fit()
        ...
        mAll.Calculate(reference:=regression.ReferenceCategory.Last)
        ...
        mDrop.Calculate(reference:=regression.ReferenceCategory.Last)
