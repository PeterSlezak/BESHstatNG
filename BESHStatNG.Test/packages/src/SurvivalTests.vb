...
Public Class Survival_Tests
    ...
    Private Shared Function LoadSurvivalCsv(fileName As String) As List(Of BESHStatNG.Survival.SurvivalRecord)
        Dim path As String = GetTestDataPath(fileName)
        Dim lines() As String = File.ReadAllLines(path)
        Dim out As New List(Of BESHStatNG.Survival.SurvivalRecord)()
        ...
        For i As Integer = 1 To lines.Length - 1 ' skip header
            ...
            Dim rec As New BESHStatNG.Survival.SurvivalRecord()
            rec.Time = t
    ...
    Public Sub KM_tabular_output_basic_matches_reference_points()
        ...
        Dim tabList As List(Of BESHStatNG.Survival.SurvivalTableRecord) =
            CType(tables(0), List(Of BESHStatNG.Survival.SurvivalTableRecord))
