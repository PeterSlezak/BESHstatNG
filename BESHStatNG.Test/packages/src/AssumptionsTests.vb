...
<TestClass()>
    ...
    Public Class Assumptions_Exact_Numeric_Tests
        ...
        Public Sub DAgostino_matches_reference()
            ...
            AssumptionsExactTestHelpers.AssertTestResult(res, 0.67283158079777516, 0.71432603415388807, 1.0E-10, 1.0E-10)
        End Sub
        ...
        Public Sub AndersonDarlingTEST_matches_reference()
            ...
            AssumptionsExactTestHelpers.AssertTestResult(res, 0.13249538810949948, 0.98099404317838035, 1.0E-12, 1.0E-12)
        End Sub
        ...
        Public Sub SymmetryTest_MiaoGelGastwirth_matches_reference()
            ...
            AssumptionsExactTestHelpers.AssertTestResult(res, -0.17366890516262309, 0.86212567620902925, 1.0E-12, 1.0E-12)
        End Sub
        ...
        Public Sub SymmetryTest_CabilioMasaro_matches_reference()
            ...
            AssumptionsExactTestHelpers.AssertTestResult(res, -0.17367974639037692, 0.86211715563670621, 1.0E-12, 1.0E-12)
        End Sub
        ...
        Public Sub BartlettTEST_matches_reference()
            ...
            AssumptionsExactTestHelpers.AssertTestResult(res, 2.4523417257880138, 0.29341395161297124, 1.0E-12, 1.0E-12)
        End Sub
        ...
        Public Sub LeveneTEST_mean_matches_reference()
            ...
            AssumptionsExactTestHelpers.AssertTestResult(res, 1.7323232323232287, 0.20120727553939535, 1.0E-12, 1.0E-12)
        End Sub
        ...
        Public Sub LeveneTEST_median_matches_reference()
            ...
            AssumptionsExactTestHelpers.AssertTestResult(res, 1.7236180904522587, 0.2027169338023673, 1.0E-12, 1.0E-12)
        End Sub
        ...
        Public Sub FlignerKilleenTEST_matches_reference()
            ...
            AssumptionsExactTestHelpers.AssertTestResult(res, 2.8113973133030843, 0.24519568899734323, 1.0E-10, 1.0E-10)
        End Sub
        ...
        Public Sub BoxM_matches_reference()
            ...
            AssumptionsExactTestHelpers.AssertTestResult(res, 63.87942360937069, 1.8783344961015503e-10, 1.0E-9, 1.0E-12)
        End Sub
        ...
        Public Sub MauchlyTest_matches_reference()
            ...
            AssumptionsExactTestHelpers.AssertTestResult(res, 1.7236099959966962, 0.63169757298113693, 1.0E-9, 1.0E-9)
        End Sub
        ...
        Public Sub Grubbs_matches_reference()
            ...
            AssumptionsExactTestHelpers.AssertAlmostEqual(2.708245645805754, AssumptionsExactTestHelpers.GetD(res, "TestStatistics1"), 1.0E-12, "Gcrit mismatch")
            AssumptionsExactTestHelpers.AssertAlmostEqual(4.2426937193607603, AssumptionsExactTestHelpers.GetD(res, "TestStatistics2"), 1.0E-12, "G mismatch")
