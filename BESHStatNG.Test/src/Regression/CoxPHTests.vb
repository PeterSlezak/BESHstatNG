...
Public Class CoxPH_Tests
    ...
    Public Sub CoxPH_Breslow_computes_all_residual_types_with_sanity_checks()
        ...
        Dim recs = LoadCoxRecords("coxph_dataset_strata_ties.csv")
        Dim cox As New CoxPH(recs, New String() {"x1", "x2"}, 200, 0.000000000001)
        Dim coxres = cox.Fit(TieMethod.Breslow)
        ...
        Dim score = cox.Residuals(ResidualType.Score)
        ...
        Dim mart = cox.Residuals(ResidualType.Martingale)
        ...
        Dim dev = cox.Residuals(ResidualType.Deviance)
        ...
        Dim sch = cox.Residuals(ResidualType.Schoenfeld)
        ...
        Dim schs = cox.Residuals(ResidualType.SchoenfeldScaled)
        ...
        Dim dfb = cox.Residuals(ResidualType.Dfbeta)
        ...
        Dim dfbs = cox.Residuals(ResidualType.Dfbetas)
        ...
        Dim cs = cox.Residuals(ResidualType.CoxSnell)
