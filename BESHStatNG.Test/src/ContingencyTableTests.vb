...
Public Class ContingencyTable_Function_Tests
    ...
    Public Sub MantelHaenszel_matches_reference()
        ...
        Const expL As Double = 1.65459539147464#
        Const expU As Double = 9.87254619988155#
    ...
    Public Sub SingleProportion_matches_reference()
        ...
        Const expL As Double = 0.386581500762253#
        Const expU As Double = 0.781193467627183#
    ...
    Public Sub TwoIndependentProportions_matches_reference()
        ...
        Const expL As Double = 0.00776268839502225#
        Const expU As Double = 0.559230398583366#
    ...
    Public Sub PairedProportions_matches_reference()
        ...
        Const expL As Double = -0.203432467996194#
        Const expU As Double = 0.00743246394109488#
    ...
    Public Sub RiskRatio_matches_reference()
        ...
        ContingencyTableTestHelpers.AssertAlmostEqual(expL, got.LowerLimit, 0.000000002, "RR CI lower (exp)")
        ContingencyTableTestHelpers.AssertAlmostEqual(expU, got.UpperLimit, 0.00000002, "RR CI upper (exp)")
    End Sub
