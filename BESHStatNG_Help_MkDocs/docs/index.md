...
- [Cohen's / Weighted Kappa](methods/cohens-kappa.md) — *Cohen's kappa (unweighted), linear / quadratic weighted kappa, Cicchetti–Allison and Fleiss–Cohen weighting schemes, analytical and bootstrap confidence intervals, confusion matrix, and weight-matrix output.* Use when two paired categorical ratings are assigned to the same items and you want a chance-corrected measure of agreement.
