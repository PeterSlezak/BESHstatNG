...
Namespace WorksheetFunctions
    ...
    ''' additive terms, polynomial terms, continuous-continuous interactions, categorical main effects, categorical-continuous
    ''' interactions, and categorical-categorical interactions can be defined from the raw predictor matrix supplied to the fit function.
    ''' </para>
    ''' </remarks>
