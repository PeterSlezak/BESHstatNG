    ...
    Public Class BoxPlot
        ...
        Sub Calculate()
            ...
            For i = 0 To pNoGroups - 1
                ...
                'Calculate quantiles and outliers for each group
        ...
        ''' </list>
        ''' 
        ''' Uses results from <c>Calculate()</c> and <c>DescriptiveStat</c>.
        ''' </summary>
        Sub CalcForPlotting()
            'Calculate values for plotting (use values generated by Calculate sub and modify them
